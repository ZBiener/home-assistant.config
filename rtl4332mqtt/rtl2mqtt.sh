...
# Install supervisord to restart rtl433 in case it crashes
#
#WORKDIR /data
#
...
/usr/local/bin/rtl_433 -R $PROTOCOL -f $FREQUENCY -g $GAIN -F json | while read line
do
  echo  "New Message"	
  echo $line
  echo "\n"
  ...
  echo "MQTT payload is: $MQTT_PATH"
